...
RUN wget -O /tmp/dex2jar.zip https://github.com/pxb1988/dex2jar/releases/download/v$DEX2JAR_VERSION/dex-tools-v$DEX2JAR_VERSION.zip
...
RUN chmod +x /opt/al_support/dex-tools-v$DEX2JAR_VERSION/*.sh
